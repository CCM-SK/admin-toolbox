...
function detect(value) {
    ...
    if (text.startsWith('{') || text.startsWith('[')) {
        try {
            ...
            throw new Error(
                'The input looks like JSON, but the JSON is invalid.'
            );
        }
    }
    ...
    results.innerHTML = `
      <section class="card">
        ...
        <div class="notice ${expiryClass}">
          ...
          >
            Expiry status is calculated from the supplied claims
            and your browser's current clock.
        ...
        <div class="card">
          ...
          <div class="muted">
            ...
            ·
            ${base64urlToBytes(encodedHeader).length}
            decoded bytes
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="muted">
            ...
            ·
            ${base64urlToBytes(encodedPayload).length}
            decoded bytes
          </div>
        </div>
